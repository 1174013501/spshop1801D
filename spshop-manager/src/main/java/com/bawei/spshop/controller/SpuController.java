...
public class SpuController {
	...
	@RequestMapping("add")
	@ResponseBody
	public String add(HttpServletRequest request, Spu spu, @RequestParam("myFile") MultipartFile file) {
	...
	public String update(HttpServletRequest request, Spu spu, @RequestParam("myFile") MultipartFile file) {
