...
import com.bawei.spshop.service.SkuService;
import com.bawei.spshop.service.SpecService;
import com.bawei.spshop.service.SpuService;
...
public class SkuController {
	...
	public String toAdd(HttpServletRequest request, @RequestParam(defaultValue = "1") int spuId) {
	...
	@RequestMapping("add")
	@ResponseBody
	public String add(HttpServletRequest request, Sku sku, @RequestParam("imageFile") MultipartFile imageFile,
	...
	@ResponseBody
	public String update(HttpServletRequest request, Sku sku, @RequestParam("imageFile") MultipartFile imageFile,
			@RequestParam("cartThumbnailFile") MultipartFile cartThumbnailFile) {
		List<SpecOption> list = sku.getOptions();
		// 数据清零一下
		for (int i = list.size() - 1; i >= 0; i--) {
